...
public class Worker_Explorer_Francois : MonoBehaviour
{
    ...
    private TeamOrchestratorFrancois m_orchestrator;
    ...
    [SerializeField] float angleRadian;
    ...
    private void Start()
    {
        m_orchestrator = TeamOrchestratorFrancois._Instance;
        TeamOrchestratorFrancois._Instance.WorkersList.Add(this);
    }
    ...
    private void Explore(float pos_X, float pos_Y, float radianAngle)
    { 
        // A REFAIRE 
        // Split petits scripts dans Agent
    }
