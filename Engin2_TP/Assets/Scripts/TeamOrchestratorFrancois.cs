...
public class TeamOrchestratorFrancois : MonoBehaviour
{
    ...
    public List<Worker_Explorer_Francois> WorkersList { get; private set; } = new List<Worker_Explorer_Francois>();
    ...
    public static TeamOrchestratorFrancois _Instance
    {
        get;
        private set;
    }
